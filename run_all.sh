...
nnUNetv2_train 223 3d_fullres 0 --val_best
...
python3 paste_back_and_post_min.py \
  --pred223   "$HOME/Documents/nnUNet_data/pred_223" \
  --meta      "$HOME/Documents/nnUNet_data/roi_meta" \
  --images221 "$HOME/Documents/nnUNet_data/nnUNet_raw/Dataset221_KidneyCoarse/imagesTs" \
  --out       "$HOME/Documents/nnUNet_data/final_fullsize" \
